...
docker exec -it \
    ...
    mongo --eval 'rs.initiate({ _id: "cgi-mongo-rep", members: [{ _id: 0, host: "mongo-primary:27017" }, { _id: 1, host: "mongo-secondary1:27017" }, { _id: 2, host: "mongo-secondary3:27017" }], settings: { getLastErrorDefaults: { w: "majority", wtimeout: 30000 }}})'
